...
- **Bugs / questions / feature ideas:** open a [GitHub issue](https://github.com/jimbo530/EARTH/issues).
...
npm run build-deploy    # regenerate deploy pages
npm run serve           # serve deploy/ at localhost:8888
```
